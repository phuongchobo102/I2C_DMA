...
uint8_t prv_btn_get_state(struct lwbtn* lw, struct lwbtn_btn* btn) {
  ...
  if(btn)
  {
    ...
    if(u8_temp == '0')
    {
      if(LL_GPIO_IsInputPinSet(ELS_USB_SENSE1_GPIO_PORT, ELS_USB_SENSE1_PIN))
      {
        result = 1;
      }else
      {
    ...
    {
      if(LL_GPIO_IsInputPinSet(ELS_USB_SENSE2_GPIO_PORT, ELS_USB_SENSE2_PIN))
      {
        result = 1;
      }else
      {
    ...
    {
      if(LL_GPIO_IsInputPinSet(ELS_USB_SENSE3_GPIO_PORT, ELS_USB_SENSE3_PIN))
      {
        result = 1;
      }else
      {
    ...
    {
      if(LL_GPIO_IsInputPinSet(ELS_USB_SENSE4_GPIO_PORT, ELS_USB_SENSE4_PIN))
      {
        result = 1;
      }else
      {
